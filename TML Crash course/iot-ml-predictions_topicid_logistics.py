...
#                                     JOIN DATA STREAMS 
      ...
      streamstojoin="Voltage_preprocessed_AnomProb,Current_preprocessed_AnomProb,Power_preprocessed_Trend,\
Voltage_preprocessed_Avg,Current_preprocessed_Avg,Power_preprocessed_Avg"
