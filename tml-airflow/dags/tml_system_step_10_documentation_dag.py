...
#    rtdsname = tsslogging.rtdprojects(sname,sd)
    ...
    if fullpathtotrainingdata:
         ...
         if len(step5sp)>0:
           mloutputurl="https:\/\/github.com/{}/{}/tree/main/tml-airflow/dags/tml-solutions/{}/mldata/{}/{}".format(os.environ["GITUSERNAME"], tsslogging.getrepo(),projectname,step5sp[-1],step5sp[-1])
