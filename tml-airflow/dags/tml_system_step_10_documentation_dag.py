...
def generatedoc(**context):    
    ...
    stitle = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="solutiontitle")
    sdesc = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="solutiondescription")
    brokerhost = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="brokerhost")
    brokerport = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="brokerport")
    cloudusername = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="cloudusername")
    cloudpassword = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="cloudpassword")
    ingestdatamethod = context['ti'].xcom_pull(task_ids='solution_task_getparams',key="ingestdatamethod")
    ...
    companyname = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="companyname")
    myname = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="myname")
    myemail = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="myemail")
    mylocation = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="mylocation")
    replication = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="replication")
    numpartitions = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="numpartitions")
    enabletls = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="enabletls")
    microserviceid = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="microserviceid")
    raw_data_topic = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="raw_data_topic")
    preprocess_data_topic = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="preprocess_data_topic")
    ml_data_topic = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="ml_data_topic")
    prediction_data_topic = context['ti'].xcom_pull(task_ids='solution_task_createtopic',key="prediction_data_topic")
    ...
    if ingestdatamethod == "localfile":
            PRODUCETYPE = context['ti'].xcom_pull(task_ids='solution_task_producetotopic',key="PRODUCETYPE")
            TOPIC = context['ti'].xcom_pull(task_ids='solution_task_producetotopic',key="TOPIC")
            PORT = context['ti'].xcom_pull(task_ids='solution_task_producetotopic',key="PORT")
            IDENTIFIER = context['ti'].xcom_pull(task_ids='solution_task_producetotopic',key="IDENTIFIER")   
    ...
    raw_data_topic = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="raw_data_topic")
    preprocess_data_topic = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="preprocess_data_topic")    
    preprocessconditions = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="preprocessconditions")
    delay = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="delay")
    array = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="array")
    saveasarray = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="saveasarray")
    topicid = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="topicid")
    rawdataoutput = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="rawdataoutput")
    asynctimeout = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="asynctimeout")
    timedelay = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="timedelay")
    usemysql = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="usemysql")
    preprocesstypes = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="preprocesstypes")
    pathtotmlattrs = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="pathtotmlattrs")
    identifier = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="identifier")
    jsoncriteria = context['ti'].xcom_pull(task_ids='solution_task_preprocess',key="jsoncriteria")
    ...
    preprocess_data_topic = context['ti'].xcom_pull(task_ids='solution_task_ml',key="preprocess_data_topic")
    ml_data_topic = context['ti'].xcom_pull(task_ids='solution_task_ml',key="ml_data_topic")
    modelruns = context['ti'].xcom_pull(task_ids='solution_task_ml',key="modelruns")
    offset = context['ti'].xcom_pull(task_ids='solution_task_ml',key="offset")
    islogistic = context['ti'].xcom_pull(task_ids='solution_task_ml',key="islogistic")
    networktimeout = context['ti'].xcom_pull(task_ids='solution_task_ml',key="networktimeout")
    modelsearchtuner = context['ti'].xcom_pull(task_ids='solution_task_ml',key="modelsearchtuner")
    dependentvariable = context['ti'].xcom_pull(task_ids='solution_task_ml',key="dependentvariable")
    independentvariables = context['ti'].xcom_pull(task_ids='solution_task_ml',key="independentvariables")
    rollbackoffsets = context['ti'].xcom_pull(task_ids='solution_task_ml',key="rollbackoffsets")
    topicid = context['ti'].xcom_pull(task_ids='solution_task_ml',key="topicid")
    consumefrom = context['ti'].xcom_pull(task_ids='solution_task_ml',key="consumefrom")
    fullpathtotrainingdata = context['ti'].xcom_pull(task_ids='solution_task_ml',key="fullpathtotrainingdata")
    transformtype = context['ti'].xcom_pull(task_ids='solution_task_ml',key="transformtype")
    sendcoefto = context['ti'].xcom_pull(task_ids='solution_task_ml',key="sendcoefto")
    coeftoprocess = context['ti'].xcom_pull(task_ids='solution_task_ml',key="coeftoprocess")
    coefsubtopicnames = context['ti'].xcom_pull(task_ids='solution_task_ml',key="coefsubtopicnames")
    ...
    preprocess_data_topic = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="preprocess_data_topic")
    ml_prediction_topic = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="ml_prediction_topic")
    streamstojoin = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="streamstojoin")
    inputdata = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="inputdata")
    consumefrom = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="consumefrom")
    offset = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="offset")
    delay = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="delay")
    usedeploy = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="usedeploy")
    networktimeout = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="networktimeout")
    maxrows = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="maxrows")
    topicid = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="topicid")
    pathtoalgos = context['ti'].xcom_pull(task_ids='solution_task_prediction',key="pathtoalgos")
    ...
    vipervizport = context['ti'].xcom_pull(task_ids='solution_task_visualization',key="VIPERVIZPORT")
