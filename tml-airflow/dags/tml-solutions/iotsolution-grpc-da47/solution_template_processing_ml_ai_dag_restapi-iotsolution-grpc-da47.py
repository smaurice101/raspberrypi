...
step1 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_1_getparams_dag-iotsolution-grpc-da47")
step2 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_2_kafka_createtopic_dag-iotsolution-grpc-da47")
step3 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-iotsolution-grpc-da47")
step4 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_4_kafka_preprocess_dag-iotsolution-grpc-da47")
step5 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_5_kafka_machine_learning_dag-iotsolution-grpc-da47")
step6 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_6_kafka_predictions_dag-iotsolution-grpc-da47")
step7 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_7_kafka_visualization_dag-iotsolution-grpc-da47")
step8 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_8_deploy_solution_to_docker_dag-iotsolution-grpc-da47")
step9 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_9_privategpt_qdrant_dag-iotsolution-grpc-da47")
step10 = importlib.import_module("tml-solutions.iotsolution-grpc-da47.tml_system_step_10_documentation_dag-iotsolution-grpc-da47")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-iotsolution-grpc-da47",
