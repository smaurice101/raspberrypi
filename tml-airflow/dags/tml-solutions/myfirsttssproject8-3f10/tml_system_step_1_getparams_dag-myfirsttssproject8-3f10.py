...
default_args = {
 ...
 'solutionname': 'myfirsttssproject8-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myfirsttssproject8-3f10", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myfirsttssproject8-3f10"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
