...
default_args = {
 ...
 'solutionname': 'myawesometmlsolutiongrpc',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolutiongrpc", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolutiongrpc"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
