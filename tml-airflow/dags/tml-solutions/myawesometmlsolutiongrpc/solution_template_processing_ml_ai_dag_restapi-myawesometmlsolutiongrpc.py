...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_1_getparams_dag-myawesometmlsolutiongrpc")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutiongrpc")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutiongrpc")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutiongrpc")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutiongrpc")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutiongrpc")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutiongrpc")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutiongrpc")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutiongrpc")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_system_step_10_documentation_dag-myawesometmlsolutiongrpc")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutiongrpc",
