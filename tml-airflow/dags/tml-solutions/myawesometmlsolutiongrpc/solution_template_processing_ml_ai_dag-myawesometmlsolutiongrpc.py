...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutiongrpc.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutiongrpc")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutiongrpc",
