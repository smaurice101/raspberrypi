...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution6.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolution6")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolution6",
