...
default_args = {
 ...
 'solutionname': 'myawesometmlsolution6',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolution6", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolution6"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
