...
@dag(dag_id="tml_system_step_6_kafka_predictions_dag_myfirstsolution", default_args=default_args, tags=["tml_system_step_6_kafka_predictions_dag_myfirstsolution"], schedule=None,catchup=False)
