...
step3 = importlib.import_module("tml-solutions.myfirsttssproject-3f10.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myfirsttssproject-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myfirsttssproject-3f10",
