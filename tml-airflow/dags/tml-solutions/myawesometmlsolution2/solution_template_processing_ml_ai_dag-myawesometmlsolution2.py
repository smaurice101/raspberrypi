...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution2.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolution2")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolution2",
