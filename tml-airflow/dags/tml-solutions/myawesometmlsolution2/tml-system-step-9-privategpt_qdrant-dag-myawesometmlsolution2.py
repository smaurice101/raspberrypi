...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_myawesometmlsolution2", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_myawesometmlsolution2"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
  basedir = "/"
