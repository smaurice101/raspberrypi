...
with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag_myawesometmlsolution2",
...
# STEP 1: Get the Parameters
  sensor_A = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_1_getparams_dag_myawesometmlsolution2",
      external_task_id="getparams",
  )
# STEP 2: Create the Kafka topics
  sensor_B = ExternalTaskSensor(
      task_id="solution_task_createtopic",
      external_dag_id="tml_system_step_2_kafka_createtopic_dag_myawesometmlsolution2",
...
# STEP 3: Produce data to topic        
  sensor_C = ExternalTaskSensor(
      ...
      external_dag_id="tml_read_RESTAPI_step_3_kafka_producetotopic_dag_myawesometmlsolution2",
      external_task_id="gettmlsystemsparams",
  )
# STEP 4: Preprocess the data        
  sensor_D = ExternalTaskSensor(
      task_id="solution_task_preprocess",
      external_dag_id="tml_system_step_4_kafka_preprocess_dag_myawesometmlsolution2",
      external_task_id="processtransactiondata",
  )
# STEP 5: ML        
  sensor_E = ExternalTaskSensor(
      task_id="solution_task_ml",
      external_dag_id="tml_system_step_5_kafka_machine_learning_dag_myawesometmlsolution2",
      external_task_id="performSupervisedMachineLearning",
  )
# STEP 6: Predictions        
  sensor_F = ExternalTaskSensor(
      task_id="solution_task_prediction",
      external_dag_id="tml_system_step_6_kafka_predictions_dag_myawesometmlsolution2",
      external_task_id="performPredictions",
  )    
# STEP 7: Visualization        
  sensor_G = ExternalTaskSensor(
      task_id="solution_task_visualization",
      external_dag_id="tml_system_step_7_kafka_visualization_dag_myawesometmlsolution2",
...
# STEP 8: Containerize the solution        
  sensor_H = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_8_deploy_solution_to_docker_dag_myawesometmlsolution2",
      external_task_id="dockerit",
  )
# STEP 9: PrivateGPT      
  sensor_I = ExternalTaskSensor(
      task_id="solution_task_ai",
      external_dag_id="tml_system_step_9_privategpt_qdrant_dag_myawesometmlsolution2",
      external_task_id="startprivategpt",
  )            
# STEP 10: Document the solution
  sensor_J = ExternalTaskSensor(
      task_id="solution_task_document",
      external_dag_id="tml_system_step_10_documentation_dag_myawesometmlsolution2",
