...
@dag(dag_id="tml_system_step_6_kafka_predictions_dag_myawesometmlsolution2", default_args=default_args, tags=["tml_system_step_6_kafka_predictions_dag_myawesometmlsolution2"], schedule=None,catchup=False)
...
def startpredictions(**context):
       ...
       wn = windowname('predict',"{},{}".format(sname,sd))     
