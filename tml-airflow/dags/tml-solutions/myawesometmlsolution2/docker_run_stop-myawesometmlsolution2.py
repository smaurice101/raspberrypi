...
default_args = {
 'solution_name' : 'myawesometmlsolution2', # << Leave blank - these will be updated by TSS
 'solution_dag' : 'solution_preprocessing_dag-myawesometmlsolution2', # << Leave blank - these will be updated by TSS     
...
@dag(dag_id="container_run_stop_process_dag_myawesometmlsolution2", default_args=default_args, tags=["container_run_stop_process_dag_myawesometmlsolution2"], schedule=None,  catchup=False)
