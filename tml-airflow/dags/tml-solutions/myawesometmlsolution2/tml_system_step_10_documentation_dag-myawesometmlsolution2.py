...
@dag(dag_id="tml_system_step_10_documentation_dag_myawesometmlsolution2", default_args=default_args, tags=["tml_system_step_10_documentation_dag_myawesometmlsolution2"], schedule=None,  catchup=False)
...
def generatedoc(**context):    
   ...
   # gitrepo = "\/{}\/tml-airflow\/dags\/tml-solutions\/{}".format(repo,sname)
    ...
    dockerrun = ("docker run -d \-\-net=host \-\-env TSS=0 \-\-env SOLUTIONNAME={} \-\-env SOLUTIONDAG={} \-\-env GITUSERNAME={} " \
                 ...
                 "\-\-env READTHEDOCS=<Enter Readthedocs token> {}".format(sname,sd,os.environ['GITUSERNAME'],os.environ['GITREPOURL'],containername))   
