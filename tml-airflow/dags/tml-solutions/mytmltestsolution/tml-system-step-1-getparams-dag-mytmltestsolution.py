...
default_args = {
 ...
 'KUBERNETES' : 0,
 'solutionname': 'mytmltestsolution',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_mytmltestsolution", default_args=default_args, tags=["tml_system_step_1_getparams_dag_mytmltestsolution"], schedule=None, start_date=datetime.datetime(2022, 3, 4), catchup=False)
def tmlparams():
    # Define tasks
  basedir = "/"
