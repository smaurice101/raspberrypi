...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'raw_data_topic' : 'logstash-logs', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'preprocess_data_topic' : 'logstash-preprocessed', # Separate multiple topics with comma <<< ********** You change topic names as needed
