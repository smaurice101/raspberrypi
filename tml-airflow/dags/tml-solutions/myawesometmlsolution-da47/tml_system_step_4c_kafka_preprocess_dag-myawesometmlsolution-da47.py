...
default_args = {
  ...
  'raw_data_topic' : 'logstash-logs', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'preprocess_data_topic' : 'logstash-preprocessed', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  ...
  'rtmsstream' : 'logstash-logs', # Change as needed - STREAM containing log file data (or other data) for RTMS
