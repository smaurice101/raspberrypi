...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-da47.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolution-da47")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolution-da47",
