...
default_args = {
 'solution_name' : 'myawesometmlsolution5', # << Leave blank - these will be updated by TSS
 'solution_dag' : 'solution_preprocessing_dag-myawesometmlsolution5', # << Leave blank - these will be updated by TSS     
...
@dag(dag_id="container_run_stop_process_dag_myawesometmlsolution5", default_args=default_args, tags=["container_run_stop_process_dag_myawesometmlsolution5"], schedule=None,  catchup=False)
