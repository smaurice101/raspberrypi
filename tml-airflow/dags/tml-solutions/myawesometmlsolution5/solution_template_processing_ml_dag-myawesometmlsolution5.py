...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution5.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolution5")
...
with DAG(
    dag_id="solution_preprocessing_ml_dag-myawesometmlsolution5",
