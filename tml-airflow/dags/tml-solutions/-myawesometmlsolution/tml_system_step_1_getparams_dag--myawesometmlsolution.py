...
@dag(dag_id="tml_system_step_1_getparams_dag_-myawesometmlsolution", default_args=default_args, tags=["tml_system_step_1_getparams_dag_-myawesometmlsolution"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
