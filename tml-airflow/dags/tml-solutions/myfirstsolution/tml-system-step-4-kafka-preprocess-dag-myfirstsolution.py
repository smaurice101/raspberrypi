...
@dag(dag_id="tml-system-step-4-kafka-preprocess-dag-myfirstsolution", default_args=default_args, tags=["tml-system-step-4-kafka-preprocess-dag-myfirstsolution"], schedule=None,catchup=False)
def startprocessing():
