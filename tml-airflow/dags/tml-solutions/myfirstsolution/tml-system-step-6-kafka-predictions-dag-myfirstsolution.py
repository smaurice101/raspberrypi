...
@dag(dag_id="tml-system-step-6-kafka-predictions-dag-myfirstsolution", default_args=default_args, tags=["tml-system-step-6-kafka-predictions-dag-myfirstsolution"], schedule=None,catchup=False)
