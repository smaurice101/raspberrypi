...
@dag(dag_id="tml_system_step_2_kafka_createtopic_dag_myfirstsolution", default_args=default_args, tags=["tml-system-step-2-kafka-createtopic-myfirstsolution"], schedule=None,catchup=False)
def startkafkasetup():
