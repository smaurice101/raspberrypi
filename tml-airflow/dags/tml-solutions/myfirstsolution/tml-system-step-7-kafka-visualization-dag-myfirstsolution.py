...
@dag(dag_id="tml-system-step-7-kafka-visualization-dag-myfirstsolution", default_args=default_args, tags=["tml-system-step-7-kafka-visualization-dag-myfirstsolution"], schedule=None,catchup=False)
def startstreaming():    
