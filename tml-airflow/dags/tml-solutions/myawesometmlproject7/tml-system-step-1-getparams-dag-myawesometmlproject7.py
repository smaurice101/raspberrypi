...
default_args = {
 ...
 'KUBERNETES' : 0,
 'solutionname': 'myawesometmlproject7',   # <<< *** Provide a name for your solution - No spaces or special characters in the name
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlproject7", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlproject7"], schedule=None, start_date=datetime.datetime(2022, 3, 4), catchup=False)
def tmlparams():
    # Define tasks
  basedir = "/"
