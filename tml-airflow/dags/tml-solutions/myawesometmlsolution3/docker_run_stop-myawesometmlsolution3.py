...
default_args = {
 'solution_name' : 'myawesometmlsolution3', # << Leave blank - these will be updated by TSS
 'solution_dag' : 'solution_preprocessing_dag-myawesometmlsolution3', # << Leave blank - these will be updated by TSS     
