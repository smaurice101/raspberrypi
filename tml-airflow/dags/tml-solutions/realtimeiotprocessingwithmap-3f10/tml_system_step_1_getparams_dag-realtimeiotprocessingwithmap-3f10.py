...
default_args = {
 ...
 'solutionname': 'realtimeiotprocessingwithmap-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'IoT Real-Time Processing with Map', # <<< *** Provide a descriptive title for your solution
...
@dag(dag_id="tml_system_step_1_getparams_dag_realtimeiotprocessingwithmap-3f10", default_args=default_args, tags=["tml_system_step_1_getparams_dag_realtimeiotprocessingwithmap-3f10"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
