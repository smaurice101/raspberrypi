...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_myawesometmlproject10", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_myawesometmlproject10"], schedule=None,catchup=False)
def startstreaming():    
