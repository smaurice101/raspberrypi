...
default_args = {
  ...
  'mqtt_port' : '883', # <<<******** Enter MQTT port i.e. 1883, 8883    (for HiveMQ cluster)
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritysolutionwithprivategpt-3f10", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritysolutionwithprivategpt-3f10"], schedule=None,catchup=False)
