...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_1_getparams_dag-myawesometmlsolutioniot-3f10")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutioniot-3f10")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutioniot-3f10")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutioniot-3f10")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutioniot-3f10")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutioniot-3f10")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutioniot-3f10")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutioniot-3f10")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutioniot-3f10")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutioniot-3f10.tml_system_step_10_documentation_dag-myawesometmlsolutioniot-3f10")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutioniot-3f10",
