...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlproject3", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlproject3"], schedule=None, start_date=datetime.datetime(2022, 3, 4), catchup=False)
def tmlparams():
    # Define tasks
  basedir = "/"
