...
default_args = {
  ...
  'raw_data_topic' : 'iot-preprocess-data', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'preprocess_data_topic' : 'iot-preprocess2-data', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'maxrows' : '3000', # <<< ********** Number of offsets to rollback the data stream -i.e. rollback stream by 500 offsets
...
@dag(dag_id="tml_system_step_4b_kafka_preprocess_dag_iotsolutionmqtt-3f10", default_args=default_args, tags=["tml_system_step_4b_kafka_preprocess_dag_iotsolutionmqtt-3f10"], start_date=datetime(2023, 1, 1),schedule=None,catchup=False)
def startprocessing():
  def empty():
     pass
dag = startprocessing()
