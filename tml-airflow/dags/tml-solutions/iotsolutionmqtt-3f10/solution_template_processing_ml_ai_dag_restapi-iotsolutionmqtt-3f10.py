...
step1 = importlib.import_module("tml-solutions.iotsolutionmqtt-3f10.tml_system_step_1_getparams_dag-iotsolutionmqtt-3f10")
...
step3 = importlib.import_module("tml-solutions.iotsolutionmqtt-3f10.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-iotsolutionmqtt-3f10")
...
step8 = importlib.import_module("tml-solutions.iotsolutionmqtt-3f10.tml_system_step_8_deploy_solution_to_docker_dag-iotsolutionmqtt-3f10")
step9 = importlib.import_module("tml-solutions.iotsolutionmqtt-3f10.tml_system_step_9_privategpt_qdrant_dag-iotsolutionmqtt-3f10")
step10 = importlib.import_module("tml-solutions.iotsolutionmqtt-3f10.tml_system_step_10_documentation_dag-iotsolutionmqtt-3f10")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-iotsolutionmqtt-3f10",
