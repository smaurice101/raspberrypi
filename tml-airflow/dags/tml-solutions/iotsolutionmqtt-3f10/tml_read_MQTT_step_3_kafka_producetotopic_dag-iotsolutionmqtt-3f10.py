...
default_args = {
  ...
  'mqtt_broker' : 'b526253c5560459da5337e561c142369.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org or HiveMQ
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_iotsolutionmqtt-3f10", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_iotsolutionmqtt-3f10"], schedule=None,catchup=False)
