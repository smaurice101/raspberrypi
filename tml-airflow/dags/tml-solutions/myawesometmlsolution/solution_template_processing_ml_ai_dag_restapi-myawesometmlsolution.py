...
with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag_myawesometmlsolution",
...
# STEP 3: Produce data to topic        
  sensor_C = ExternalTaskSensor(
      ...
      external_dag_id="tml_read_RESTAPI_step_3_kafka_producetotopic_dag_myawesometmlsolution",
...
# STEP 5: ML        
  sensor_E = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_5_kafka_machine_learning_dag_myawesometmlsolution",
      external_task_id="performSupervisedMachineLearning",
  )
# STEP 6: Predictions        
  sensor_F = ExternalTaskSensor(
      task_id="solution_task_prediction",
      external_dag_id="tml_system_step_6_kafka_predictions_dag_myawesometmlsolution",
...
# STEP 9: PrivateGPT      
  sensor_I = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_9_privategpt_qdrant_dag_myawesometmlsolution",
