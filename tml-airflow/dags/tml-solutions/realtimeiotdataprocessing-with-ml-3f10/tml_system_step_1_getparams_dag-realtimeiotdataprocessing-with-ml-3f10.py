...
default_args = {
 ...
 'solutionname': 'realtimeiotdataprocessing-with-ml-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'Real-Time IoT Data Preprocessing: Voltage, Current, Power with Machine Learning', # <<< *** Provide a descriptive title for your solution
...
@dag(dag_id="tml_system_step_1_getparams_dag_realtimeiotdataprocessing-with-ml-3f10", default_args=default_args, tags=["tml_system_step_1_getparams_dag_realtimeiotdataprocessing-with-ml-3f10"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
