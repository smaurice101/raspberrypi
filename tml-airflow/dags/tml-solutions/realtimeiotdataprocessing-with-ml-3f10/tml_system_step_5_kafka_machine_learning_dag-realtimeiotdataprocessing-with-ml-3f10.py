...
default_args = {
  ...
  'preprocess_data_topic' : 'iot-preprocess2', # << *** topic/data to use for training datasets - You created this in STEP 2
  'ml_data_topic' : 'iot-trained-params-input', # topic to store the trained algorithms  - You created this in STEP 2
...
@dag(dag_id="tml_system_step_5_kafka_machine_learning_dag_realtimeiotdataprocessing-with-ml-3f10", default_args=default_args, tags=["tml_system_step_5_kafka_machine_learning_dag_realtimeiotdataprocessing-with-ml-3f10"], schedule=None,catchup=False)
