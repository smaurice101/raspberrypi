...
default_args = {
  ...
  'preprocess_data_topic' : 'iot-preprocess2', # << *** data for the independent variables - You created this in STEP 2
  ...
  'pathtoalgos' : '/Viper-tml/viperlogs/iotlogistic', # << this is specified in fullpathtotrainingdata in STEP 5
...
@dag(dag_id="tml_system_step_6_kafka_predictions_dag_realtimeiotdataprocessing-with-ml-3f10", default_args=default_args, tags=["tml_system_step_6_kafka_predictions_dag_realtimeiotdataprocessing-with-ml-3f10"], schedule=None,catchup=False)
