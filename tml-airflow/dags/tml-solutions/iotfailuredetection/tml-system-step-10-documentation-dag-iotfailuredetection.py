...
@dag(dag_id="tml_system_step_10_documentation_dag_iotfailuredetection", default_args=default_args, tags=["tml_system_step_10_documentation_dag_iotfailuredetection"], schedule=None,  catchup=False)
def startdocumentation():
  ...
  try:
      ...
      tsslogging.git_push("/{}".format(repo),"Entry fron {}".format(os.path.basename(__file__)))                    
      generatedoc()  
