...
with DAG(
    dag_id="solution_preprocessing_ml_restapi_dag_mytmlsolution5",
...
# STEP 1: Get the Parameters
  sensor_A = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_1_getparams_dag_mytmlsolution5",
      external_task_id="getparams",
  )
# STEP 2: Create the Kafka topics
  sensor_B = ExternalTaskSensor(
      task_id="solution_task_createtopic",
      external_dag_id="tml_system_step_2_kafka_createtopic_dag_mytmlsolution5",
...
# STEP 8: Containerize the solution        
  sensor_H = ExternalTaskSensor(
      ...
      external_dag_id="tml_system_step_8_deploy_solution_to_docker_dag_mytmlsolution5",
      external_task_id="dockerit",
  )
# STEP 10: Document the solution
  sensor_I = ExternalTaskSensor(
      task_id="solution_task_document",
      external_dag_id="tml_system_step_10_documentation_dag_mytmlsolution5",
