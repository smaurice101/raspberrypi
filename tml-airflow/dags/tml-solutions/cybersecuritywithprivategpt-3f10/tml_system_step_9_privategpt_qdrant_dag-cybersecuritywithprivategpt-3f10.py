...
default_args = {
 ...
 'context' : 'Any inbound and outbound packets that is greater than 1000 Megabytes, should be suspicious.', # what is this data about? Provide context to PrivateGPT
