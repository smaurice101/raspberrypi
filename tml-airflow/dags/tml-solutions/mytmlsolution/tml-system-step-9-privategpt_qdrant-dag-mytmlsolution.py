...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_mytmlsolution", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_mytmlsolution"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
  basedir = "/"
