...
default_args = {
  ...
  'inputfile' : '/rawdata/IoTData.txt2',  # <<< ***** replace ?  to input file name to read. NOTE this data file should be JSON messages per line and stored in the HOST folder mapped to /rawdata folder 
...
@dag(dag_id="tml_localfile_step_3_kafka_producetotopic_dag_iotsolution-3f10", default_args=default_args, tags=["tml_localfile_step_3_kafka_producetotopic_dag_iotsolution-3f10"], start_date=datetime(2023, 1, 1),  schedule=None,catchup=False)
