...
default_args = {
 ...
 'solutionname': '-myawesometmlsolution2',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_-myawesometmlsolution2", default_args=default_args, tags=["tml_system_step_1_getparams_dag_-myawesometmlsolution2"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
