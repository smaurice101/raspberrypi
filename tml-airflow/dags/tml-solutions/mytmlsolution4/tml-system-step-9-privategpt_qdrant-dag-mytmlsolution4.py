...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_mytmlsolution4", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_mytmlsolution4"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
  basedir = "/"
