...
@dag(dag_id="tml-system-step-6-kafka-predictions-dag-mysecondsolution", default_args=default_args, tags=["tml-system-step-6-kafka-predictions-dag-mysecondsolution"], schedule=None,catchup=False)
