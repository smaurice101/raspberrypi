...
@dag(dag_id="tml-system-step-7-kafka-visualization-dag-mysecondsolution", default_args=default_args, tags=["tml-system-step-7-kafka-visualization-dag-mysecondsolution"], schedule=None,catchup=False)
def startstreaming():    
