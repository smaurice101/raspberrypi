...
step3 = importlib.import_module("tml-solutions.myfirsttssproject3-3f10.tml_read_gRPC_step_3_kafka_producetotopic_dag-myfirsttssproject3-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ml_grpc_dag-myfirsttssproject3-3f10",
