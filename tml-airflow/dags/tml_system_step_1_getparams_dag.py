...
def getparams(**context):
  ...
  task_instance.xcom_push(key='VIPERPORT',value="p={}".format(VIPERPORT))
  ...
  task_instance.xcom_push(key='VIPERPORTPREPROCESS',value=str(VIPERPORTPREPROCESS))
  task_instance.xcom_push(key='VIPERHOSTML',value=VIPERHOSTML)
  task_instance.xcom_push(key='VIPERPORTML',value=str(VIPERPORTML))
  task_instance.xcom_push(key='VIPERHOSTPREDICT',value=VIPERHOSTPREDICT)
  task_instance.xcom_push(key='VIPERPORTPREDICT',value=str(VIPERPORTPREDICT))
  task_instance.xcom_push(key='HTTPADDR',value=HTTPADDR)
  task_instance.xcom_push(key='HPDEHOST',value=HPDEHOST)
  task_instance.xcom_push(key='HPDEPORT',value=str(HPDEPORT))
  task_instance.xcom_push(key='HPDEHOSTPREDICT',value=HPDEHOSTPREDICT)
  task_instance.xcom_push(key='HPDEPORTPREDICT',value=str(HPDEPORTPREDICT))
